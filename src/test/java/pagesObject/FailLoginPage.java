...
public class FailLoginPage extends PageObject {
    ...
    @FindBy(xpath = "//*[@id='page-36']/div/div[1]/ul")
    WebElementFacade labelValidationFail;
    ...
    public void verifyMyAccount(List<String> parameters) {
        ...
        String textToVerify = labelValidationFail.getText();
